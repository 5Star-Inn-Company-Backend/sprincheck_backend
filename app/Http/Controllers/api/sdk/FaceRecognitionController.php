...
class FaceRecognitionController extends Controller
{
    public function merchant(Request $request)
    {
        ...
        $fee= (new \App\Models\TransactionFee)->getTransactionFee($biz->id,"FACE_DETECTION");
    ...
    public function merchant_liveness(Request $request)
    {
        ...
        $fee= (new \App\Models\TransactionFee)->getTransactionFee($biz->id,"FACE_LIVENESS");
    ...
    public function merchant_compare(Request $request)
    {
        ...
        $fee= (new \App\Models\TransactionFee)->getTransactionFee($biz->id,"FACE_COMPARE");
